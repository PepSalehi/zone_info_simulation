...
history = dqn.fit(env, nb_steps=200, nb_episodes=200,action_repetition=1, visualize=False, verbose=2)

dqn.save_weights('dqn_weights_%s.h5f' % (200), overwrite=True)
    ...
    #                              percentage_know_fare = perc_k, AV_share=av)
