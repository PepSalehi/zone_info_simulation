...
THIS doesn't work, see https://medium.com/@jwnx/multiprocessing-serialization-in-python-with-pickle-9844f6fa1812
"""
...
#        fleet_sizes = args.fleet
    ...
    with Pool(processes=5) as pool:
        results = pool.starmap(do_it, product(fleet_sizes,surges,perc_know,pro_share,range(n_rep)))
